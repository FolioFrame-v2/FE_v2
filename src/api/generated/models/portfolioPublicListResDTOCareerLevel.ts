...
export type PortfolioPublicListResDTOCareerLevel = typeof PortfolioPublicListResDTOCareerLevel[keyof typeof PortfolioPublicListResDTOCareerLevel];


export const PortfolioPublicListResDTOCareerLevel = {
  NONE: 'NONE',
