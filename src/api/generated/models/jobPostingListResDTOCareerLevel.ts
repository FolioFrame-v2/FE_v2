...
export type JobPostingListResDTOCareerLevel = typeof JobPostingListResDTOCareerLevel[keyof typeof JobPostingListResDTOCareerLevel];


export const JobPostingListResDTOCareerLevel = {
  NONE: 'NONE',
