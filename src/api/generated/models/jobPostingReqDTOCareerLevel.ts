...
export type JobPostingReqDTOCareerLevel = typeof JobPostingReqDTOCareerLevel[keyof typeof JobPostingReqDTOCareerLevel];


export const JobPostingReqDTOCareerLevel = {
  NONE: 'NONE',
