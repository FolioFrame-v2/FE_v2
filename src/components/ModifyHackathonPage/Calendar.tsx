...
import { Color } from "@/components/CreatePortfolioPage/Color.jsx";

const ModifyHackathonCalendar = ({ onStartDateChange, onEndDateChange }: any) => {
...
export default ModifyHackathonCalendar;
