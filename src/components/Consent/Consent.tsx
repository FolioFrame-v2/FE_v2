      ...
      <div className="space-y-6 max-h-[50vh] overflow-y-auto pr-2 custom-scrollbar">
        ...
        <section className="space-y-3">
          <label className="flex items-center justify-between cursor-pointer group">
            <h3 className="font-semibold text-ink">1. 개인정보 보호 동의 <span className="text-coral text-xs ml-1">(필수)</span></h3>
        ...
        <section className="space-y-3">
          <label className="flex items-center justify-between cursor-pointer group">
            <h3 className="font-semibold text-ink">2. {type === "recruiter" ? "포트폴리오 무단 사용 금지 동의" : "서비스 이용 및 포트폴리오 공개 동의"} <span className="text-coral text-xs ml-1">(필수)</span></h3>
        ...
        <section className="space-y-3">
          <label className="flex items-center justify-between cursor-pointer group">
            <h3 className="font-semibold text-ink">3. 위반 시 제재 및 손해배상 <span className="text-coral text-xs ml-1">(필수)</span></h3>
