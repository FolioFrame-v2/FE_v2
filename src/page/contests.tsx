...
const CONTESTS: Contest[] = [
  { id: "c1", title: "2026 카카오 해커톤", host: "Kakao", region: "서울", field: "AI/ML", team: "4~6인", prize: "5,000만원", deadline: "2026-07-30", dDay: 34, accent: "var(--color-mint)" },
  { id: "c2", title: "오픈소스 컨트리뷰톤", host: "OSSCA", region: "원격", field: "오픈소스", team: "2~3인", prize: "1,000만원", deadline: "2026-08-12", dDay: 47, accent: "var(--color-coral)" },
  { id: "c3", title: "교육 데이터 분석 챌린지", host: "교육부", region: "전국", field: "에듀테크", team: "1인", prize: "2,000만원", deadline: "2026-07-05", dDay: 9, accent: "var(--color-mint)" },
  { id: "c4", title: "모바일 앱 공모전", host: "Samsung", region: "수원", field: "라이프스타일", team: "2~3인", prize: "3,000만원", deadline: "2026-09-01", dDay: 67, accent: "var(--color-coral)" },
  { id: "c5", title: "클라우드 아키텍처 콘테스트", host: "AWS", region: "서울", field: "인프라", team: "4~6인", prize: "1,500만원", deadline: "2026-07-20", dDay: 24, accent: "var(--color-mint)" },
  { id: "c6", title: "헬스케어 IoT 챌린지", host: "보건복지부", region: "부산", field: "헬스케어", team: "7인+", prize: "1억원", deadline: "2026-10-10", dDay: 106, accent: "var(--color-coral)" },
];

const GROUPS: FilterGroup[] = [
  { key: "type", label: "유형", options: ["공모전", "해커톤"] },
...
function ContestsPage() {
  const [filters, setFilters] = useState<Record<string, string>>({ region: "전체", field: "전체", team: "전체" });
